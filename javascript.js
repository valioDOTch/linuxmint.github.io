...
window.onload = function() {
    document.body.onkeypress =  function(event) {
        ...
        if (string.toLowerCase().indexOf('conway') > -1) {
            ...
            document.body.innerHTML += '<div id="stuff" style="display: none; text-align: center"><canvas id="canvas" width="901" height="387" style="border: 1px solid black;"></canvas><br /><span id="buttonRun" style="padding-right: 20px;">Run</span><span id="buttonClear">Clear </span><br />Adapted from <a href="https://github.com/pmav/game-of-life">https://github.com/pmav/game-of-life</a>.</div>';
            func();
        }
    };
};
